...
\ilc{FGSM} is a \textit{white-box} evasion attack algorithm. Being \text{white-box} meaning the attacker was assumed to have access to the internal of the model,
